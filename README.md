...
- [Dashboard - Sales Insights (Tableau)](https://github.com/TMranga20)  
  Interactive dashboards and visualizations to help stakeholders understand product metrics.

(Replace links above with project repositories or portfolio pages.)

---

## Current Focus
Expanding automation coverage, designing maintainable test frameworks, and delivering stable, production-ready software.
